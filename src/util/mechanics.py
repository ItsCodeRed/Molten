...
class goto():
    ...
    def run(self, agent):
        ...
        agent.controller.handbrake = True if within_turn_radius(agent.me, adjusted_target if best_boost_location != 0 else self.target_location) else agent.controller.handbrake
